...
!function(t, e) {
    ...
    o._getItemLayoutPosition = function(t) {
        ...
        for (var r = this._getRowGroup(o), s = Math.min.apply(Math, r), h = r.indexOf(s), a = {
            x: s,
            y: this.rowHeight * h
        }, n = s + t.size.outerWidth, u = this.rows + 1 - r.length, g = 0; g < u; g++)
            this.rowXs[h + g] = n;
        return a
    }
    ,
    ...
    o._manageStamp = function(e) {
        ...
        for (var n = (this._getOption("originLeft") ? o.left : o.right) + i.outerWidth, u = h; u <= a; u++)
