...
!function(t) {
    ...
    V.widget("ui.slider", V.ui.mouse, {
        ...
        _createRange: function() {
            ...
            this.range && this.range.length ? (this._removeClass(this.range, "ui-loan-range-min ui-loan-range-max"),
            this.range.css({
                left: "",
                bottom: ""
            })) : (this.range = V("<div>").appendTo(this.element),
            this._addClass(this.range, "ui-loan-range")),
            "min" !== t.range && "max" !== t.range || this._addClass(this.range, "ui-loan-range-" + t.range)) : (this.range && this.range.remove(),
            this.range = null)
        },
